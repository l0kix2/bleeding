...
.. code-block:: bash
    ...
    heroku run python bleeding/manage.py syncdb --noinput --settings=config.settings
    heroku run python bleeding/manage.py migrate --settings=config.settings
    heroku run python bleeding/manage.py collectstatic --settings=config.settings
